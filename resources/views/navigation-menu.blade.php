<nav x-data="{ open: false }" class="bg-gray-900 border-b border-gray-100">
    ...
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="flex flex-col items-center flex-shrink-0 py-2 space-x-2 text-center">
                    <a href="{{ route('dashboard') }}">
                        <x-jet-application-mark class="block w-auto h-6" />
                    </a>
                    <h1 class="text-2xl font-semibold text-center text-white font-rightsyd">around the world</h1>
                </div>
                ...
                <div class="relative ml-3">
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out bg-gray-900 border border-transparent rounded-md hover:text-yellow-300 focus:outline-none">
                                        {{ Auth::user()->name }}
