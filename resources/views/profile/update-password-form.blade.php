<x-jet-form-section submit="updatePassword">
    ...
    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="current_password" type="password" class="block w-full mt-1" wire:model.defer="state.current_password" placeholder="Default Password: DJSatw2021" autocomplete="current-password" />
